    ...
    <>
      ...
      <article className={styles.blogPost}>
        ...
        <div className={styles.blogContent}>
          ...
          <p className={styles.caption}>
            <span className={styles.captionTitle}>Diverse Environments and Objects.</span> DreamDojo produces realistic action-conditioned rollouts for GR-1, G1, AgiBot, and YAM across a wide range of environments and object interactions. (videos generated by the post-trained model)
          </p>
          ...
          <p className={styles.caption}>
            <span className={styles.captionTitle}>Teacher vs. Student in 1-Minute Rollouts.</span> DreamDojo reaches real-time 10 FPS generation through autoregressive few-step distillation. We compare speeds before (left) and after (right) teacher-student distillation.
          </p>
