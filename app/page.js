      ...
      <article className={styles.blogPost}>
        <div className={styles.center}>
          ...
          <div className={styles.linkContainer}>
            <a href="TODO" className={`${styles.textLink} ${styles.borderedLink}`} target="_blank" rel="noopener noreferrer">
              Paper
            </a>
        ...
        <div className={styles.blogContent}>
          ...
          <ol className={styles.highlightsList}>
            ...
            <li>
              <span className={styles.highlightTitle}>A distillation pipeline.</span> A distilled world model that achieves long-horizon autoregressive generation, with stable real-time interactions at 10 FPS for over 1 minute.
            </li>
          </ol>
          ...
          <p className={styles.caption}>
            <span className={styles.captionTitle}>Diverse Environments and Objects.</span> DreamDojo produces realistic rollouts for Fourier GR1, Unitree G1, AgiBot, and Bimanual YAM across a wide range of environments and object interactions. Videos are generated by the teacher model.
          </p>
          ...
          <p className={styles.caption}>
            <span className={styles.captionTitle}>Real-time Rollouts.</span> DreamDojo reaches real-time 10 FPS generation through autoregressive few-step distillation. We compare speeds before (left) and after (right) teacher-student distillation.
          </p>
